...
public class MimeTypeParser {
	...
	public static void main(String[] args) {
		try {
			...
			String tomcatMimetypes = StringUtils.substringBetween(contents, "<!-- deployment descriptor.                                               -->", "<!-- ==================== Default Welcome File List ===================== -->");
	...
	protected static String getString(Map<String, String> mimeTypes) {
